...
class RestaurantRequest{
    func getRestaurantData(VC: FindViewController,pageNo: Int) {
        let url = "http://apis.data.go.kr/3510500/general_restaurants/getList?serviceKey=lFJpGBqJV2efZuUTJX%2Flndu%2BilGklnYbx8amGgV3ItzUUrVCa38U1aFKa2b%2F58vnLrJbhKjgPLnez5QMEpfY9g%3D%3D&type=JSON&pageNo=\(pageNo)&numOfRows=400"
